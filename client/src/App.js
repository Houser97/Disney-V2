      ...
      <div className="App">
        <div className='full-height'>
          ...
          <Routes >
            ...
            <Route path='/movies' element = {<MoviesAndSeries key={"movieSectionRender"} titleSection = {"Movies"}  /*headerRefPlaceholder = {header}*/ />} ></Route>
            <Route path='/series' element = {<MoviesAndSeries key={"serieSectionRender"} titleSection = {"Series"} /*headerRefPlaceholder = {header}*/ />} ></Route>
